...
export function DataRoomAccessRequestPage() {
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      showSuccess("Request sent. An administrator will review your Data Room access request.");
          ...
          <div className="relative mx-auto grid max-w-7xl gap-8 px-6 py-12 md:grid-cols-[0.9fr_1.1fr] md:py-16">
            <div className="flex flex-col justify-center">
              ...
              <h1 className="mt-5 max-w-xl font-headline text-4xl font-extrabold leading-tight md:text-5xl">
                Technical Review Access Request
              </h1>
              <p className="mt-4 max-w-xl text-sm leading-7 text-white/80">
                Submit your contact details and the reason for your review. An administrator will evaluate
                the request, set the expiration date, and enable read-only visitor access.
              </p>
              <div className="mt-7 grid gap-3 text-sm text-white/85">
                <div className="flex items-center gap-3">
                  <ShieldCheck className="h-5 w-5 text-[#f2c879]" />
                  Access expires on the date defined by administration.
                </div>
                <div className="flex items-center gap-3">
                  <Database className="h-5 w-5 text-[#f2c879]" />
                  Visitor permission is limited to the Data Room.
                </div>
              </div>
            </div>
            ...
            >
              <h2 className="font-headline text-2xl font-extrabold">Applicant details</h2>
              <p className="mt-2 text-sm text-[#64748b]">
                Use an email and phone number where we can coordinate access delivery.
              </p>
