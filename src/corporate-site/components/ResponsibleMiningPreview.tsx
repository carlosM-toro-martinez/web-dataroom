...
export default function ResponsibleMiningPreview() {
  return (
    <section className="responsible-preview scroll-reveal bg-[#f6f8f7] py-24" id="responsible-mining">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="reveal-up">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#0a4d68]/15 bg-white px-4 py-2 text-sm font-semibold text-[#0a4d68] shadow-sm">
          ...
          <Link
            ...
            className="motion-button inline-flex items-center justify-center gap-2 rounded-lg bg-[#0a4d68] px-6 py-3 font-semibold text-white shadow-lg transition hover:bg-[#083d54]"
          >
        ...
        <div className="responsible-preview__visual reveal-up reveal-delay-2 grid gap-4 sm:grid-cols-[0.85fr_1.15fr]">
          <div className="image-lift overflow-hidden rounded-xl border border-white bg-white shadow-xl">
            <img
              src={safetyImage}
              alt="Safety training at Minera Marte"
              className="h-full min-h-[360px] w-full object-cover transition duration-700 hover:scale-[1.04]"
            />
          </div>
          <div className="space-y-4">
            <div className="image-lift overflow-hidden rounded-xl border border-white bg-white shadow-xl">
              <img
                ...
                className="h-56 w-full object-cover transition duration-700 hover:scale-[1.04]"
              />
            </div>
              ...
              {responsibleMiningPillars.map((pillar, index) => {
                ...
                return (
                  <Link
                    ...
                    className="motion-card group rounded-xl border border-[#dbe5e7] bg-white p-4 shadow-sm transition hover:border-[#0a4d68]/35 hover:shadow-xl"
                  >
